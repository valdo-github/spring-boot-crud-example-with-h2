...
- Swagger can be launched in Browser: http://localhost:8080/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config 

![image](https://user-images.githubusercontent.com/59571096/201428459-36b454b3-4d7b-42bc-8420-ad81ad80d63d.png)

- H2 Console On Browser: http://localhost:8080/h2-console
...
- #### Sports Man CRUD Operations
    > **GET Mapping** http://localhost:8080/sports-icon  - Get all Sports Manes
    
    > **GET Mapping** http://localhost:8080/sports-icon/1  - Get Sports Man by ID
       
    > **POST Mapping** http://localhost:8080/sports-icon  - Add new Sports Man in DB  
    ...
    > **PUT Mapping** http://localhost:8080/sports-icon/3  - Update existing Sports Man for given ID 
    ...
    > **DELETE Mapping** http://localhost:8080/sports-icon/4  - Delete Sports Man by ID

- #### Reactive Sports Man CRUD Operations
    > ###### **GET Mapping** http://localhost:8080/reactive/sports-icon  - Get all Sports Manes 
    
     ## **(Try above endpoint in Chrome to see magic, Postman currently not supporting reactive programming)**
    
    > **GET Mapping** http://localhost:8080/reactive/sports-icons/1  - Get Sports Icon by ID
       
    > **POST Mapping** http://localhost:8080/reactive/sports-icons - Add new Sports Icon in DB  
    ...
    > **PUT Mapping** http://localhost:8080/reactive/sports-icons/3  - Update existing Sports Man for given ID 
    ...
    > **DELETE Mapping** http://localhost:8080/reactive/sports-icons/4  - Delete Sports Man by ID


- #### Student Get Operations using JPA
    > **GET Mapping** http://localhost:8080/students  - Get all Employees 
    
    > **GET Mapping** http://localhost:8080/students/2  - Get Student by ID
